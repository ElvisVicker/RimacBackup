...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/admin/vendors/jvectormap/jquery-jvectormap-2.0.3.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/admin/css/main.min.css') }}">

    {{-- <link rel="stylesheet" href="{{ asset('assets/admin/css/themes/green.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/admin/css/themes/blue.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/admin/css/themes/blue-light.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/admin/css/themes/green-light.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/admin/css/themes/orange-light.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/admin/css/themes/orange.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/admin/css/themes/pink-light.css') }}"> --}}
...
<body class="fixed-navbar">
    ...
    <script src="{{ asset('assets/admin/vendors/metisMenu/dist/metisMenu.min.js') }}"></script>
    <script src="{{ asset('assets/admin/vendors/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
    <script src="{{ asset('assets/admin/vendors/chart.js/dist/Chart.min.js') }}"></script>
    <script src="{{ asset('assets/admin/vendors/jvectormap/jquery-jvectormap-2.0.3.min.js') }}"></script>
    <script src="{{ asset('assets/admin/vendors/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
    <script src="{{ asset('assets/admin/vendors/jvectormap/jquery-jvectormap-us-aea-en.js') }}"></script>
    <script src="{{ asset('assets/admin/js/app.min.js') }}"></script>
    <script src="{{ asset('assets/admin/js/scripts/dashboard_1_demo.js') }}"></script>
